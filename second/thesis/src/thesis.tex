...
Um die zusätzlichen Herausforderungen beim Testen von Web-Applikationen zu bewältigen, sind zusätzliche Werkzeuge von Nöten, die vor allem beim Testen der verschiedenen Plattformen behilflich sind. Dazu wurde im Rahmen eines Praktikums bei onwCloud Inc. eine App erstellt, welche dann mit Testfällen abgedeckt wurde. Bei der App handelt es sich um eine RSS und Atom News Reader App, welche auf der von der Firma entwickelten Plattform, ownCloud\cite{owncloud}, aufsetzt.
