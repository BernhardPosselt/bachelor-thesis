...
\begin{itemize}
  \item Security
  \item Konfiguration
  \item Kompatibiltät der Applikation mit dem Server Betriebssystem und den serverseitigen Applikationen
  \item Recovery Funktionen
  \item Performance und Speicherverbrauch
  \item Installation
