...
Durchf"uhrung und Erstellen von automatisierten Tests f"ur Web-Applikationen unterscheidet sich von klassichen Applikationen. Durch die komplexere Infrastruktur und Modularisierung werden zus"atzliche Testf"alle und Strategien ben"otigt um Web-Applikationen ausreichend abzudecken und eine fortw"ahrende Qualit"at zu gew"ahrleisten. Diese Arbeit soll M"oglichkeiten f"ur den Test von Web-Applikationen aufzeigen.

\vfill
\paragraph*{Schlagw"orter:} Webapplikationen, automatisierte Tests, Webtest
...
%Qualit"at muss bestandteil des prozesses sein \cite{betrieb}[S. 16] entsteht w"ahrend der entwicklung, sehr selten bis unmöglich am ende einzubauen \cite{betrieb}[S. 11] 

%fr"uh gefundene Fehler l"asst sich mit weniger resourcen beheben als wenn sp"ater \cite{betrieb}[S. 17] 
