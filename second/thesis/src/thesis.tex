...
\begin{figure}[h!]
\centering
\includegraphics[width=120mm]{img/globaldevicesales.png}
\caption[Entwicklung der PC und Mobilgerätverkäufe]{Entwicklung der PC und Mobilgerätverkäufe, Quelle: The Future Of Mobile, Henry Blodget. Zahlen von Gartner, IDC, Strategy Analytics, company filings, BI Intelligence estimates}\label{Abb1}
\end{figure}
...
% TODO: grafik mit verteilung der OS, prognose? 
...
%innovationsfaktor reinbringen der arbeit

\section{Aufbau}
% TODO: mehr text, nicht immer mit kapitel X anfangen
...
% TODO: auch reinbringen dass man beide braucht
...
% TODO: ablauf reinbringen + grafik
...
\chapter{Testplan}
% TODO: 4.1 ohne 4.2 gibt es nicht, besser strukturieren, PDCA reinbringen? ablauf des testplans stärker hervorheben
...
% TODO: grafik des webstacks reinbringen
% TODO: stärker strukturieren
