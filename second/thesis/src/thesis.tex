...
Durch diesen modularen Aufbau ist es besonders schwer einen Fehler zu lokalisieren. Der Fehler z.B. durch einen Fehler im Quellcode des Applikations-Servers oder durch ein Netzwerkproblem entstanden sein. \cite{testing_apps_on_web}[Foreword]
