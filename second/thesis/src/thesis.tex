...
\begin{itemize}
  \item Der Modularität, Fragmentierung und das Session Modell kann mit einer Anpassung der System Tests begegnet werden, indem mittels VMs unterschiedliche Server- und Clientplattformen simuliert werden können
