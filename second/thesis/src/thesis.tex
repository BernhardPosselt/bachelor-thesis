...
Serverseitige Unit Tests werden wie traditionelle Unit Tests erstellt.
...
\newpage
Folgender Code soll dieses Problem verdeutlichen: Der angeführte Code führt einen AJAX Request aus und schreibt abhängig von der zurückgegebenen Datenstruktur einen Text in ein Element mit der id \emph{field}:
