...
Eine weitere Herausforderung stellt das Instanzmodell von Web-Applikationen dar: viele Web-Applikationen erlauben durch das Verwenden von \emph{Cookies} mehrere Instanzen der Applikation, welche jedoch unter der gleichen Session ausgeführt werden. Dies kann zu Synchronisationsproblemen zwischen den einzelnen Instanzen führen, z.B. kann in einer Instanz ein Eintrag gelöscht werden, der durch eine fehlerhafte Synchronisation für die andere Instanz jedoch noch immer existiert und in weiterer Folge zu Fehlern führen kann. \cite{testing_apps_on_web}[S. 20]
