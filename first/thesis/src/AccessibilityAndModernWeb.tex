...
Eine gute Trennung der verschiedenen Layer ist notwendig, damit auch Clients, die sich nur auf das Markup konzentrieren den Inhalt korrekt darstellen k"onnen\cite[S. 42-43]{barr_webd}. Auch sollen die korrekten HTML Elemente f"ur die jeweils daf"ur vorgesehenen Einsatzzwecke verwendet werden, um den Inhalt korrekt zu "ubermitteln. \cite[Abschnitt 6.3]{wcag1}
