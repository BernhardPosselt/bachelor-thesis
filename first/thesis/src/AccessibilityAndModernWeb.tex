...
Die WCAG 2.0 unterscheiden sich von der Version 1.0 nicht nur in der Struktur sondern auch am Unfang und der Testbarkeit. Wo in 1.0 noch eher allgemeine Hinweise gegeben wurden, sind in Version 2.0 klare und testbare Anleitungen und Richtlinien vorhanden. Auch die Umbenennung der Kriterien von Priorit"at zu Konformit"atslevel zeigt den Wunsch einer besseren automatisierten Testbarkeit der Kriterien. \cite[Abschnitt Introduction]{wcag2}
...
\subsection{Wahrnehmbarkeit}
Die WCAG 2.0 geben im Gegensatz zu 
\subsection{Bedienbarkeit}
\subsection{Verst"andlichkeit}
\subsection{Robustheit}
