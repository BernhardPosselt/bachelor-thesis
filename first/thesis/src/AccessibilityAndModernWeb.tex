...
Die Anzahl der Personen, die Probleme beim Lesen von Displays aufweisen, wird weltweit auf sechs Millionen Personen \cite{screen_read_frust}, die Anzahl blinder Personen in den USA wird auf eine Million und weltweit auf 38 Millionen Personen gesch"atzt.
\cite{screen_read}.
...
\cite{screen_read_frust}. Bestimmte Screen Reader wie GNOME Orca \cite{orca} sind sogar frei f"ur jederman verf"ugbar. 
