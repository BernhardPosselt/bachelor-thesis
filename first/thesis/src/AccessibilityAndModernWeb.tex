...
\begin{itemize}
\item Struktur und Pr"asentation soll getrennt werden\cite[Abschnitt 6.3]{wcag1}
...
\subsubsection{Struktur und Pr"asentation soll getrennt werden}
